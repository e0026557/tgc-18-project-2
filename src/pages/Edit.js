			...
			<React.Fragment>
				<section className='container-fluid d-flex flex-column justify-content-center align-items-center adjust-margin-top'>
					<div className='container mt-3 mb-5 px-2 px-md-5'>
						...
						<div className='recipe-form px-5 py-3'>

							<h5 className='font-weight-500 mt-4'>General Info</h5>
							...
							<h5 className='font-weight-500 mt-4'>Method Info</h5>
							<div className='recipe-form-group row px-3 py-3 mt-3'>
								{/* Total brew time */}
								<Form.Group className='col-lg-6 mb-3'>
									<Form.Label>
							...
							<h5 className='font-weight-500 mt-4'>Grinder Info</h5>
							<div className='recipe-form-group row px-3 py-3 mt-3'>
								{/* Grinder */}
								<Form.Group className='col-lg-6 mb-3'>
									<Form.Label>
							...
							<h5 className='font-weight-500 mt-4'>Water Info</h5>
							<div className='recipe-form-group row px-3 py-3 mt-3'>
								{/* Water amount */}
								<Form.Group className='col-lg-6 mb-3'>
									<Form.Label>
							...
							<h5 className='font-weight-500 mt-4'>Others</h5>
							<div className='recipe-form-group row px-3 py-3 mt-3'>
								...
								<Form.Group className='mb-3'>
									...
									<div className='d-flex justify-content-start align-items-center flex-wrap gap-1 gap-md-3 mt-1'>
										<div>
											...
											/>
											<label htmlFor='option-ingredients-edit' className='ms-2'>
												Additional Ingredients
											</label>
										</div>
										<div>
											<input
												id='option-equipment-edit'
												type='checkbox'
												name='optionalFields'
												value='equipment'
												onChange={this.updateFormField}
											...
											/>
											<label htmlFor='option-equipment-edit' className='ms-2'>
							...
							<h5 className='font-weight-500 mt-4'>Instructions</h5>
							<div className='recipe-form-group row px-3 py-3 mt-3'>
								{/* Steps */}
								<Form.Group className='mb-3'>
									<Form.Label>
