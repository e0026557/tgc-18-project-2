      ...
      <Container fluid>
        ...
        <Navbar.Collapse id='basic-navbar-nav'>
          <Nav className='me-auto'>
            ...
            <Nav.Link
              className={props.activePage === 'recipes' ? 'active' : ''}
              href='#recipes' onClick={() => {
            ...
            <Nav.Link
              className={props.activePage === 'create' ? 'active' : ''}
              href='#create' onClick={() => {
            ...
            <Nav.Link
              className={props.activePage === 'favorites' ? 'active' : ''}
              href='#favorites' onClick={() => {
